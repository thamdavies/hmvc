# Đề bài
Là user tôi muốn tạo bài viết, dữ liệu sẽ được suggest từ api ở bên dưới hoặc nhập tay cho title và description.
`https://jsonplaceholder.typicode.com/posts`
+ Input title cho phép user nhập từ khoá, bên tay phải có button cho phép user mở modal search bài viết theo title để user chọn bài post có sẵn
+ Title là require
+ Handle case gọi API bị lỗi và thông báo lỗi cho user
##### Áp dụng mô hình hMVC đã hướng dẫn trước đó.
